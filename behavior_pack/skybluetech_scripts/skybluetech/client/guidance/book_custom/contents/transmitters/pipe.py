...
pipe_entry = PageGroup(
    ...
    [
        TextPage(
            "流体管道",
            '一般的流体管道能安全输送所有常温无害的液体或气体， 当你需要输送一些特殊流体例如<text color="§9" t="低温">、 <text color="§c" t="高温">流体， 则需要拥有特殊功能的管道， 如<text color="§d" t="耐寒或耐热流体管道">。 流体管道无法输送不符合要求的流体， 一旦强制输送则很可能导致管道破裂、 流体外泄造成污染。',
        ),
        TOCPage([
            TOCPageSection(
