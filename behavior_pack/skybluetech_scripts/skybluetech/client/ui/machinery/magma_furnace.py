...
from skybluetech_scripts.skybluetech.common.machinery_def.magma_furnace import (
    STORE_RF_MAX,
    MAX_FLUID_VOLUME,
    recipes,
)
...
@RegistToolDeltaScreen("MagmaFurnaceUI.main", is_proxy=True)
class MagmaFurnaceUI(MachinePanelUIProxyEx):
